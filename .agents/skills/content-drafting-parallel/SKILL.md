...
description: Drafts marketing content across various channels including blog posts, social media, newsletters, and more. Use when writing channel-specific, SEO-optimized copy or developing headlines and calls to action.
---
...
When working on projects for **Parallel Adventure**, you MUST refer to the core DNA document BEFORE drafting any content:
- [Parallel Adventure DNA](file:///Users/loloamoravain/antigravity/content_factory/references/parallel_adventure_dna.md)

> [!IMPORTANT]
> Always check the Parallel Adventure DNA to ensure the "Chill & Transparent" tone and core pillars are respected.

## File Storage Rules

All social media post drafts and content related to marketing campaigns MUST be stored in the following directory:
- `/Users/loloamoravain/antigravity/content_factory/posts/`
