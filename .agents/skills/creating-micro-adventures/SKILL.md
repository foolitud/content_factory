---
name: creating-micro-adventures
description: Creates narrative micro-adventures for Parallel (WhatsApp) following a structured 5-step process: Ideation, Production, Knowledges, Marketing, and TikTok promotion.
---
...
> [!IMPORTANT]
> **ORGANISATION DES FICHIERS** : Pour chaque micro-aventure, tu dois créer un dossier dédié dans : `aventures/micro-aventures/[NOM_AVENTURE]`.
